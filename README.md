...
If you are using any identity other than User Login, you may refer to the following for terraform authentication.<br>
...
3. Permission check - assign required roles <br>
...
- RBAC <br>
Scope: root management group <br>
role: Management Group Contributor <br>
Scope: subscription (targeted subscription) <br>
